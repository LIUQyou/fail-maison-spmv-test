...
{ 
  ...
  printf("Number of non-zeros per row:\t%f,\n", anz/((float)N));
  printf("(sum*100)/anz:\t%f\n", ((float)sum*100)/anz);
  printf("num_diags:\t%d\n", num_diags);
  printf("diag_elem, diag_elem/anz:\t%lld,%f\n", diag_elem, (double)diag_elem/anz); 
  printf("ell_elem, ell_elem/anz:\t%lld,%f\n", ell_elem, (double)ell_elem/anz);
  printf("empty_rows:\t%f\n", (float)empty_rows*100/N);
  printf("one_rows:\t%f\n", (float)one_rows*100/N);
  printf("two_rows:\t%f\n", (float)two_rows*100/N);
  printf("three_rows:\t%f\n", (float)three_rows*100/N);
  printf("four_rows:\t%f\n", (float)four_rows*100/N);
  printf("one_rows:\t%f\n", (float)five_rows*100/N);
  printf("total_small_rows:\t%f\n", (float)total_small_rows*100/N);
  ...
  */
  printf("total_elems_small_rows:\t%f\n", (float)total_elems_small_rows*100/anz);
  printf("mean_i(diff_nnz_row, N-1):\t%f\n", mean_i(diff_nnz_row, N-1));
  printf("min_nnz_row:\t%d\n", min_nnz_row);
  printf("max_nnz_row:\t%d\n", max_nnz_row);
  printf("mean_i(nnz_row, N):\t%f\n",  mean_i(nnz_row, N));
  printf("vr_i(nnz_row, N, mean_i(nnz_row, N)):\t%f\n", vr_i(nnz_row, N, mean_i(nnz_row, N)));
  printf("sd_i(nnz_row, N, mean_i(nnz_row, N)):\t%f\n", sd_i(nnz_row, N, mean_i(nnz_row, N)));
  ...
  printf("min_col_width/N, max_col_width/N, mean_i(col_width, N):\t%e,%e,%e\n", (float)min_col_width/N, (float)max_col_width/N, mean_i(col_width, N));
  printf("geo_mean(scatter_row, N):\t%.3f\n", geo_mean(scatter_row, N)); 
  printf("geo_mean(misses, N):\t%e\n", geo_mean(misses, N));
  printf("(2 * anz)/(8 * anz + 12 * N):\t%e\n", (float)(2 * anz)/(8 * anz + 12 * N));
